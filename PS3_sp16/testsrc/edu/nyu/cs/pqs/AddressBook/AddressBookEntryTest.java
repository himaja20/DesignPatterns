...
public class AddressBookEntryTest {
  ...
  public void adressShouldBeSet(){
    entry.setPostalAddress("Test, 107 Soth drive,"
        + " new Jersey, 07306");
    assertEquals("Test, 107 Soth drive, new Jersey,"
        + " 07306",entry.getPostalAddress());
  }
  ...
  public void phoneShouldBeSet(){
    ...
    assertEquals
    (000000000000000000000000000000000000000000000,entry.getPhoneNumber());
  }

  /*
   * This test fails as the phone number 00000 is 
   * cut down to 0 in the result
   */
  @Test
  public void toStringShouldBeReturned(){
    ...
    entry.setName("Test");
    entry.setNote("notes");
    String expected = "Test,test, new Jersey,"
        + " 07306,000000,Test@gmail.com,notes";
    String result = entry.toString();
    assertEquals(expected,result);
  }

  /*
   * Equals tests fail with errors as the 
   * author has not implemented all the properties
   * of an equals contract
   */
  @Test
